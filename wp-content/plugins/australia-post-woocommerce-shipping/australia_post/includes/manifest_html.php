<?php
	$url              = untrailingslashit(plugins_url()) . '/australia-post-woocommerce-shipping/australia_post/images/australiapost-6.png';
...
if (!empty($_GET) && isset($_GET['print_manifest'])) {
	...
	if (isset($_GET['print_manifest']) && ( $_GET['print_manifest'] == 'yes' )) {
		if ($startrack_manifest_order_id != '') {
			...
			} elseif (isset($_GET['manifest_download_method_selected']) && ( $_GET['manifest_download_method_selected'] == 'inline' )) {
