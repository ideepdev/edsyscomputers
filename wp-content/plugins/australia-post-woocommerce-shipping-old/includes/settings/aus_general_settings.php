...
<table style="font-size:13px;">
    <tr valign="top">
        <td style="width:40%;font-weight:700;">
            <label for="wf_australia_post_contracted_api_mode"><?php _e('Account Details','wf-shipping-auspost') ?> </label>
        </td>
        <td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
            <fieldset style="padding:3px;">
                <input class="input-text regular-input " size="40" type="text" name="wf_australia_post_api_key" id="wf_australia_post_api_key"  value="<?php echo (isset($general_settings['api_key'])) ? $general_settings['api_key'] : ''; ?>" placeholder="8fd6e23e-15fd-4e87-b7a2-ba557b0ff0dd"> <label for="wf_australia_post_ac_num"><?php _e('API Key','wf-shipping-auspost') ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('On Registering with Australia Post, you would get an  API key which you are required to fill in here. Applicable for both Contracted and Non-contracted accounts.','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <fieldset style="padding:3px;">
                <input class="input-text regular-input " type="checkbox" name="wf_australia_post_contracted_rates" id="wf_australia_post_contracted_rates"  <?php echo (isset($general_settings['contracted_rates']) && $general_settings['contracted_rates'] =="yes") ? 'checked' : ''; ?> > <label for="wf_australia_post_ac_num"><?php _e('Contracted Account','wf-shipping-auspost') ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('If you have an Australia Post account, enable Contracted.','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <p style="font-size: 80%; padding: 0% !important; margin: 0% !important;"><?php _e('(Go to Rates & Services tab and save the settings while switching from contracted to non-contracted account and Vice versa.)', 'wf-shipping-auspost')?></p>
            <fieldset style="padding:3px;" id="aus_live_test">
                ...
                { ?>
                <input class="input-text regular-input " type="radio" name="wf_australia_post_contracted_api_mode"  id="wf_australia_post_contracted_api_mode"  value="test" placeholder=""> <?php _e('Test Mode','wf-shipping-auspost') ?>
                <input class="input-text regular-input " type="radio"  name="wf_australia_post_contracted_api_mode" checked=true id="wf_australia_post_contracted_api_mode"  value="live" placeholder=""> <?php _e('Live Mode','wf-shipping-auspost') ?>
                <?php }else{ ?>
                <input class="input-text regular-input " type="radio" name="wf_australia_post_contracted_api_mode" checked=true id="wf_australia_post_contracted_api_mode"  value="test" placeholder=""> <?php _e('Test Mode','wf-shipping-auspost') ?>
                <input class="input-text regular-input " type="radio" name="wf_australia_post_contracted_api_mode" id="wf_australia_post_contracted_api_mode"  value="live" placeholder=""> <?php _e('Live Mode','wf-shipping-auspost') ?>
                <?php } ?>
                <br>
            </fieldset>
            ...
            <fieldset style="padding:3px;" id="aus_pass">
                <input class="input-text regular-input " type="password" name="wf_australia_post_api_pwd" id="wf_australia_post_api_pwd"  value="<?php echo (isset($general_settings['api_pwd'])) ? $general_settings['api_pwd'] : ''; ?>" placeholder="" required="true" novalidate> <label for="wf_australia_post_"><?php _e('API password','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e('If you have enabled Contracted, then enter the API password here.','wf-shipping-auspost') ?>"></span>  
            </fieldset>
            <fieldset style="padding:3px;" id="aus_acc_num">
                <input class="input-text regular-input " type="Password" name="wf_australia_post_api_account_no" id="wf_australia_post_api_account_no"  value="<?php echo (isset($general_settings['api_account_no'])) ? $general_settings['api_account_no'] : ''; ?>" placeholder="**************" required="true" novalidate/>
                <label for="wf_australia_post_api_account_no"><?php _e('Account Number','wf-shipping-auspost') ?><font style="color:red;">*</font></label>
                <span class="woocommerce-help-tip" data-tip="<?php _e('Account Number of your Australia Post Account','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <br>
            <fieldset style="padding:3px;" id="starTrack_account_rates_select_field">
                <input class="input-text regular-input " type="checkbox" name="wf_australia_post_starTrack_rates" id="wf_australia_post_starTrack_rates"  <?php echo (isset($general_settings['wf_australia_post_starTrack_rates']) && $general_settings['wf_australia_post_starTrack_rates'] =="yes") ? 'checked' : ''; ?> > <label for="wf_australia_post_starTrack_rates"><?php _e('I have a StarTrack Account','wf-shipping-auspost') ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('If you have a StarTrack account, enter your StarTrack account number to get StarTrack rates.','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <fieldset style="padding:3px;" id="starTrack_pass">
                <input class="input-text regular-input " type="password" name="wf_australia_post_starTrack_api_password" id="wf_australia_post_starTrack_api_password"  value="<?php echo (isset($general_settings['wf_australia_post_starTrack_api_pwd'])) ? $general_settings['wf_australia_post_starTrack_api_pwd'] : ''; ?>" placeholder=""> <label for="wf_australia_post_"><?php _e('API password','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e( 'Enter API password if you have selected Contracted Account.','wf-shipping-auspost') ?>"></span>  
            </fieldset>
            <fieldset style="padding:3px;" id="starTrack_acc_num">
                <input class="input-text regular-input " type="Password" name="wf_australia_post_starTrack_api_account_no" id="wf_australia_post_starTrack_api_account_no"  value="<?php echo (isset($general_settings['wf_australia_post_starTrack_api_account_no'])) ? $general_settings['wf_australia_post_starTrack_api_account_no'] : ''; ?>" placeholder="**************" />
                <label for="wf_australia_post_starTrack_api_account_no" id="wf_australia_post_starTrack_api_account_no_label"><?php _e('Account Number','wf-shipping-auspost') ?><font style="color:red;">*</font></label>
                <span class="woocommerce-help-tip" id="wf_australia_post_starTrack_api_account_no_datatip" data-tip="<?php _e('Account Number of your StarTrack Contract Account','wf-shipping-auspost') ?>"></span>
            </fieldset>            
            <fieldset style="padding:3px;" class="elex_australia_post_starTrack_api_key_field">
                <input class="input-text regular-input " type="checkbox" name="wf_australia_post_starTrack_api_key_selected" id="wf_australia_post_starTrack_api_key_selected"  <?php echo (isset($general_settings['wf_australia_post_starTrack_api_key_selected']) && $general_settings['wf_australia_post_starTrack_api_key_selected']) ? 'checked' : ''; ?> > <label for="wf_australia_post_starTrack_api_key_selected"><?php _e('I have a separate API Key for StarTrack','wf-shipping-auspost') ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('If you have a separate StarTrack API, enter your StarTrack API to get StarTrack rates.','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <fieldset style="padding:3px;" class="elex_australia_post_starTrack_api_key_field elex_australia_post_starTrack_api_key_input_field">
                <input class="input-text regular-input " size="40" type="text" name="wf_australia_post_starTrack_api_key" id="wf_australia_post_starTrack_api_key"  value="<?php echo (isset($general_settings['wf_australia_post_starTrack_api_key'])) ? $general_settings['wf_australia_post_starTrack_api_key'] : ''; ?>" placeholder="8fd6e23e-15fd-4e87-b7a2-ba557b0ff0dd"> <label for="wf_australia_post_ac_num"><?php _e('StarTrack API Key','wf-shipping-auspost') ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('Enter the specific API Key of StarTrack.','wf-shipping-auspost') ?>"></span>
            </fieldset>
        </td>
    </tr>
    <tr valign="top">
        <td style="width:40%;font-weight:700;">
            <label for="wf_australia_post_rates"><?php _e('Enable/Disable','wf-shipping-auspost') ?></label>
        </td>
        <td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
            <fieldset style="padding:3px;">
                <input class="input-text regular-input " type="checkbox" name="wf_australia_post_enabled" id="wf_australia_post_enabled" style="" value="yes" <?php echo (!isset($general_settings['enabled']) || isset($general_settings['enabled']) && $general_settings['enabled'] ==='yes') ? 'checked' : ''; ?> placeholder=""> <?php _e('Enable Real time Rates','wf-shipping-auspost') ?> <span class="woocommerce-help-tip" data-tip="<?php _e('Enable real time rates, if you want to fetch rates from Australia Post API in Cart/Checkout page.','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <fieldset style="padding:3px;" id="gst_include_exclude">
                <?php 
                    if(isset($general_settings['include_exclude_gst']) && $general_settings['include_exclude_gst'] == "exclude")
                    {                        
                        $exclude = 'checked';
                        $include = '';
                ...
                ?>
                <input class="input-text regular-input " type="radio" name="wf_australia_post_include_exclude_gst" <?php echo($include)?> id="wf_australia_post_include_gst"  value="include" placeholder="" > 
                <?php _e('Show Rates Included GST','wf-shipping-auspost') ?>
                <input class="input-text regular-input " <?php echo($exclude)?> type="radio" name="wf_australia_post_include_exclude_gst" id="wf_australia_post_exclude_gst"  value="exclude" placeholder=""> 
                <?php _e('Show Rates Excluded GST','wf-shipping-auspost') ?>
                <br>
            </fieldset>
            <fieldset style="padding:3px;" id="aus_enable_shipping_label">
                <input class="input-text regular-input " type="checkbox" name="wf_australia_post_enabled_label" id="wf_australia_post_enabled_label" style="" value="yes" <?php echo (!isset($general_settings['enabled_label']) || isset($general_settings['enabled_label']) && $general_settings['enabled_label'] ==='yes') ? 'checked' : ''; ?> placeholder=""> <?php _e('Enable Shipping Label (Contracted)','wf-shipping-auspost') ?> <span class="woocommerce-help-tip" data-tip="<?php _e('Enable Shipping label is available only if you have enabled Contracted. This option enables label creation from the order admin page. Disabling this will hide the label creating button.','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <fieldset style="padding:3px;">
                <input class="input-text regular-input " type="checkbox" name="wf_australia_post_debug_mode" id="wf_australia_post_debug_mode" style="" value="yes" <?php echo (isset($general_settings['debug_mode']) && $general_settings['debug_mode'] ==='yes') ? 'checked' : ''; ?> placeholder=""> <?php _e('Enable Developer Mode','wf-shipping-auspost') ?> <span class="woocommerce-help-tip" data-tip="<?php _e('Enabling Developer’s mode will let you troubleshoot the plugin. Request/Response information would be available in the Cart/Checkout page.','wf-shipping-auspost') ?>"></span>
            </fieldset>
            <?php
    ...
    <tr valign="top">
        <td style="width:40%;font-weight:700;">
            <label for="wf_australia_post_"><?php _e('Default Currency','wf-shipping-auspost') ?></label>
        </td>
        <td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
            <fieldset style="padding:3px;">
                ...
                ?>
                <label for="wf_australia_post_"><?php echo '<b>'.$selected_currency.' ('. get_woocommerce_currency_symbol($selected_currency).')</b>'; ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('Australian Dollars in the default currency.','wf-shipping-auspost') ?>"></span><br/>
            </fieldset>
<!--    
    <?php 
            if($selected_currency != $default_currency)
            {
                ?>
                <fieldset style="padding:3px;">
                <label for="wf_australia_post_conversion_rate"><?php _e('Converstion Rate','wf-shipping-auspost') ?></label> <span class="woocommerce-help-tip" data-tip="Enter the conversion rate from your Australia Post (AUD) currency to your store <?php echo '('.$default_currency.')'; ?> currency. "></span> <br/>   
    ...
    <tr valign="top">
        <td style="width:40%;font-weight:700;">
            <label for="wf_australia_post_"><?php _e('Shipper Address','wf-shipping-auspost') ?></label>
        </td>
        <td scope="row" class="titledesc" style="display: block;margin-bottom: 20px;margin-top: 3px;">
            ...
            <table>
                <tr>
                    <td>
                        <fieldset style="padding-left:3px;">
                            <label for="wf_australia_post_"><?php _e('Shipper Name','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e('Name of the person responsible for shipping.','wf-shipping-auspost') ?>"></span>  <br/>
                ...
                <td>
                        ...
                        <fieldset style="padding-left:3px;">
                            ...
                            <label for="wf_australia_post_origin_suburb"><?php _e('Suburb','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e('City of the shipper.','wf-shipping-auspost') ?>"></span>   <br/>
                ...
                <td>
                        ...
                        <fieldset style="padding-left:3px;">
                            ...
                            <label for="wf_australia_post_origin_state"><?php _e('State Code','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e('State Code of the shipper.','wf-shipping-auspost') ?>"></span>  <br/>
                ...
                <td>
                        ...
                        <fieldset style="padding-left:3px;">
                            <label for="wf_australia_post_"><?php _e('Address','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e('Official address of the shipper.','wf-shipping-auspost') ?>"></span>   <br> 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <fieldset style="padding-left:3px;">
                            <label for="wf_australia_post_"><?php _e('Phone Number','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e('Phone number of the shipper.','wf-shipping-auspost') ?>"></span>  <br/>
                    ...
                    <td>
                        <fieldset style="padding-left:3px;">
                            <label for="wf_australia_post_"><?php _e('Email Address','wf-shipping-auspost') ?></label> <span class="woocommerce-help-tip" data-tip="<?php _e('Email address of the shipper.','wf-shipping-auspost') ?>"></span> <br/>
                ...
                <tr>
                    ...
                    <fieldset style="padding-left:3px;">
                        ...
                        <label for="wf_australia_post_origin"><?php _e('Postal Code','wf-shipping-auspost') ?><font style="color:red;">*</font></label> <span class="woocommerce-help-tip" data-tip="<?php _e('Postal code of the shipper(Used for fetching rates and label generation).','wf-shipping-auspost') ?>"></span><br/>
...
?>
    <tr>
        <td colspan="2">
            <h3><?php _e( 'ELEX Australia Post Bulk Label Printing Add-On Settings', 'wf-shipping-auspost' ); ?></h3>
    ...
    <tr>
        <td style="width:40%;font-weight:700;">
                <label for="wf_australia_post_"><?php _e('Project Key', 'wf-shipping-auspost'); ?></label>
        </td>
        <td>
            <fieldset style="padding-left:3px;">
    ...
    <tr>
        <td style="width:40%;font-weight:700;">
                <label for="wf_australia_post_"><?php _e('Secret Key', 'wf-shipping-auspost'); ?></label>
        </td>
        <td>
            <fieldset style="padding-left:3px;">
...
<tr>
    <td colspan="2" style="text-align:right;">
        <button type="submit" class="button button-primary" name="wf_aus_genaral_save_changes_button"> <?php _e('Save Changes','wf-shipping-auspost') ?> </button>       
    </td>
</tr>
</table>
