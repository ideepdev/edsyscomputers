...
printf( esc_html__( 'Notification to let you know &mdash; order PO Number #%1$s belonging to %2$s has been cancelled:', 'woocommerce' ), esc_html( $purchase_number ), esc_html( $user_name ) ); ?></p>
