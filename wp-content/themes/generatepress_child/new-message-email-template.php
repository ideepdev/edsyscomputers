...
<p>
	...
	if ($quote === 'no'){
		...
		## Add CC to admin email only
		if( class_exists('addCCEmailTob2bking') ){
			add_filter( 'woocommerce_email_headers', [ 'addCCEmailTob2bking', 'b2bking_new_message_email_cc_email_headers' ], 9999, 3 );
		}
